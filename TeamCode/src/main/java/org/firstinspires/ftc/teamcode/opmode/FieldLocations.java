...
public class FieldLocations {
    ...
    public final static Pose sampleStartPose = new Pose(0, 3.0, Math.toRadians(90));
    ...
    public static Pose subShortSidePose = new Pose(34, 36.5, Math.toRadians(90));
    ...
    public final static Pose specimenSpike3DropPose = new Pose(103, 4, Math.toRadians(90));
    public final static Pose specimenSpike3GrabPose = new Pose(103, 1.5, Math.toRadians(90));

    //
    public final static Pose humanPlayerDropPose = new Pose(98, 7, Math.toRadians(90));

    public final static Pose specimenGrabSetupPose = new Pose(73.5, 8, Math.toRadians(90));
