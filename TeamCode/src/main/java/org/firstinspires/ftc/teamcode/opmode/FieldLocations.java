...
public class FieldLocations {
    ...
    public final static Pose bucketPose = new Pose(-16, 5.75, Math.toRadians(45));

    // position to grab the brick at the innermost spike mark
    public final static Pose sampleSpike1Pose = new Pose(-9, 16.55, Math.toRadians(90));

    // position to grab the brick at the middle spike mark
    public final static Pose sampleSpike2Pose = new Pose(-19, 16.55, Math.toRadians(90));
